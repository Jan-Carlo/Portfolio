      ...
      items: [
        {
          ...
          status: 'I developed my portfolio using Bootstrap and Tailwind CSS to create a responsive and visually appealing design. Leveraging Bootstrap’s grid system and pre-built components, I ensured a seamless layout across devices. ',
          tech: 'Bootstrap, Tailwind',
          github: 'https://github.com/Jan-Carlo/tailwind_portfolio/tree/tailwind',
          demo: 'https://jan-carlo.github.io/tailwind_portfolio/dist/index.html'
        },
        {
          id: 2,
          name: 'Weather App',
          imageUrl: 'portfolio-v1',
          status: 'I developed a weather app using Vue and Vuetify to create a dynamic and responsive user interface. Utilizing JavaScript, I integrated a weather API to fetch real-time data, allowing users to easily view current weather conditions and forecasts.',
          tech: 'Vue,Vuetify,JavaScript,API',
          github: 'https://github.com/Jan-Carlo/weather_app',
          demo: 'https://weather-app-wheat-ten-89.vercel.app/'
        },
        {
          id: 3,
          name: 'To do List',
          imageUrl: 'portfolio-v3',
          status: 'I created a simple to-do list application using Vue and Vuetify to deliver a clean and responsive user interface. By leveraging JavaScript, I implemented features such as adding, editing, and deleting tasks, enabling users to manage their to-do items effectively. ',
          tech: 'Vue,Vuetify,JavaScript,API',
          github: 'https://github.com/Jan-Carlo/TodoList',
          demo: 'https://todo-list-eight-opal.vercel.app/'
        }
      ]
    };
  }
