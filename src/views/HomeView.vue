<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Jan Carlo dela Cerna</h1>
      <div class="py-2">
        <h1
      ...
      <a
        :href="resumePath"
        download="Resume_Jan_Carlo_dela_Cerna.pdf"
  ...
  <img
    ...
    width="400"
    height="400"
    class="rounded-full border-4 border-blue-200 pict"
    src="/img/profile.jpg"
  >
</div>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Information Technology Student","Web Developer", "UI/UX Designer","Front-end Developer" ],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
      resumePath: '/Resume_Jan_Carlo_dela Cerna.pdf',
    };
  },
  mounted() {
    this.$nextTick(() => {
