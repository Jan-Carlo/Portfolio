...
<template>
  <div
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Jan Carlo dela Cerna. I am acquiring a strong foundation in computing, networking, and software development. 
            My experience as a Web Developer allows me to build and maintain responsive websites using HTML, CSS, and JavaScript, ensuring optimal functionality and user experience.
            In my role as a UI/UX Designer,
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I focus on enhancing user satisfaction through intuitive interface design and usability testing. Additionally, as a Front-end Developer, 
            I implement visually appealing client-side applications that engage users across various devices and screen sizes.
          </p>
        </div>
      </section>
      ...
      <section class="mt-8">
        <div class="text-lg font-bold text-white mb-3">Education</div>
        <p class="text-sm md:text-base text-justify">
          I graduated from Caraga State University with a Bachelor of Science in Information Technology. My academic journey equipped me with essential skills and knowledge in software development and networking.
        </p>
      </section>
